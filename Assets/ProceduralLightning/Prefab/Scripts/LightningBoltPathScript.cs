...
namespace DigitalRuby.ThunderAndLightning
{
    public abstract class LightningBoltPathScriptBase : LightningBoltPrefabScriptBase
    {
        ...
        [Tooltip("Whether to show the lightning path points in the design view")]
        public bool ShowLightningPath = true;
        ...
        protected override void OnDrawGizmos()
        {
            ...
            DoGizmoCleanup();
            bool noLightningPath = (!ShowLightningPath || LightningPath == null || LightningPath.List == null || LightningPath.List.Count == 0);
            ...
            for (int index = 0; index < LightningPath.List.Count; index++)
            {
                ...
                gizmoScript.hideFlags = HideFlags.HideInInspector | HideFlags.NotEditable;
